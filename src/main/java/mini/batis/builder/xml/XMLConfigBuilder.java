package mini.batis.builder.xml;

import mini.batis.builder.BaseBuilder;
import mini.batis.datasource.DataSourceFactory;
...
import mini.batis.mapping.SqlCommandType;
...
/**
 * 通过XML配置文件配置填充Configuration配置类，
 * 解析添加SQL语句并注册Mapper映射器
 */
